...
// igl::stb::read_image because it's behaving very strangely
//
// Inputs:
    ...
    igl::opengl::ViewerData & data)
{
  ...
  // what in the world is going on with igl::stb::read_image
  ...
  // No alpha igl::stb::read_image seems confused...
  A.setConstant(255);
